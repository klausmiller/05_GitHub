...
write(x = r_file, file = paste(substr(working_folder,1,nchar(working_folder)-47),'03_Shared/01_KlausMiller_LennartKraft/05_GitHub/01_Algorithms/01_R/StackAndCodeSegments.R', sep = ''))
...
write(x = r_file, file = paste('/Users/lennartkraft/dropbox/03_Shared/01_KlausMiller_LennartKraft/05_GitHub/01_Algorithms/01_R/StackAndCodeSegments.R', sep = ''))
#### ####
