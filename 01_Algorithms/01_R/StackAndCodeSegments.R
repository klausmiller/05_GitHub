...
if (user == 'mac'){
  timestart = read.csv( "/Users/lennartkraft/Dropbox/03_Shared/01_KlausMiller_LennartKraft/02_Data/04_output/02_StaFe/timestart_SciPen999.csv")
}
if (user == 'linux'){
  timestart = read.csv( "/home/kraft/Dropbox/03_Shared/01_KlausMiller_LennartKraft/02_Data/04_output/02_StaFe/timestart_SciPen999.csv")
}
if (user == 'windows'){
  timestart = read.csv( "D:/Dropbox/03_Shared/01_KlausMiller_LennartKraft/02_Data/04_output/02_StaFe/timestart_SciPen999.csv")
}
...
if (user == 'linux'){
  write(x = r_file, file = '/home/kraft/Dropbox/dropbox/03_Shared/01_KlausMiller_LennartKraft/05_GitHub/01_Algorithms/01_R/StackAndCodeSegments.R')
}
if (user == 'windows'){
